...
internal class ProjectFileProcessor : IDependencyProcessor
{
    ...
    public List<Dependency> GetDependenciesFromReferences(List<PackageReference> references)
    {
        ...
        foreach (var reference in references)
        {
            ...
            var dep = new Dependency(
                rpid.Id,
                ComponentType.NuGet,
                reference.AllowedVersions ?? new VersionRange(rpid.Version),
                ProjectFramework,
                true);
    ...
    public virtual List<PackageReference> GetPackageReferences()
    {
        ...
        foreach (var reference in project.GetItems("Reference"))
        {
            ...
            {
                var firstSep =
                    packageInfoAfterVersionKey.IndexOf(",", StringComparison.Ordinal);
            ...
            PackageReference plainref = new (
                new PackageIdentity(artifact, vers),
                ProjectFramework,
                false,
                false,
                false,
    ...
    public DependencyResolution ResolveUseGather()
    {
        ...
        {
            return new DependencyResolution(true);
        }
        ...
        DependencyResolution resolution = new(true);
    ...
    public DependencyResolution ResolveUsingLib()
    {
        ...
        var resolvedDeps = NugetApi.ResolveDependenciesForPackageReference(references);
...
internal class ProjectXmlFileProcessor : ProjectFileProcessor
{
    ...
    public override List<PackageReference> GetPackageReferences()
    {
        ...
        foreach (XmlNode package in packagesNodes)
        {
            ...
            PackageIdentity identity = new(name, null);
